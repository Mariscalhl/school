...
<body>
        ...
        $sql = "SELECT * from programs INNER JOIN courses ON programs.program_name = courses.program WHERE programs.program_id = 'P004'";
        ...
        if ($result ->num_rows > 0) {
            while ($row = $result-> fetch_assoc()) {
                ...
                //echo "<h2>" . $row["course_semester"] . "</h2><ul><li>". $row["course_name"] . "(". $row["course_code"] . ")</li></ul>";
                    ...
                    }elseif ($row["course_code"] == "CWMD2200") {
                    ...
                    }elseif ($row["course_code"] == "CWMD3200") {
                    ...
                    }elseif ($row["course_code"] == "CWMD4200") {
